  ...
  <body>
    ...
    <div class="row">
      <div style="background-color: #2A3964;font-family: Verdana; margin-left: 5px ; margin-top: 0px ; width: 160px ; height: 1000px;" > {{-- TODO EL SIDEBAR --}}
        ...
        <a style=" margin-left: 15px ; width: 138px ; background-color: #B8D8F8; color: #000066; display: block; font-size: 11px; font-weight: bold; margin-bottom: 25px; margin-top: -20px ; padding: 6px 8px; text-decoration: none;" href="#">Consulta Libros</a>
        <a style=" margin-left: 15px ; width: 138px ; background-color: #B8D8F8; color: #000066; display: block; font-size: 11px; font-weight: bold; margin-bottom: 25px; margin-top: -20px ; padding: 6px 8px; text-decoration: none;" href="#">Pagos en Caja</a>
        ...
        <a style=" margin-left: 15px ; width: 138px ; background-color: #B8D8F8; color: #000066; display: block; font-size: 11px; font-weight: bold; margin-bottom: 25px; margin-top: -20px ; padding: 6px 8px; text-decoration: none;" href="#">Bibliotecas Virtuales</a>
        <a style=" margin-left: 15px ; width: 138px ; background-color: #B8D8F8; color: #000066; display: block; font-size: 11px; font-weight: bold; margin-bottom: 25px; margin-top: -20px ; padding: 6px 8px; text-decoration: none;" href="#">Bloqueos</a>
        <a style=" margin-left: 15px ; width: 138px ; background-color: #B8D8F8; color: #000066; display: block; font-size: 11px; font-weight: bold; margin-bottom: 25px; margin-top: -20px ; padding: 6px 8px; text-decoration: none;" href="#">Avance de Contenido</a>
        <a style=" margin-left: 15px ; width: 138px ; background-color: #B8D8F8; color: #000066; display: block; font-size: 11px; font-weight: bold; margin-bottom: 25px; margin-top: -20px ; padding: 6px 8px; text-decoration: none;" href="#">Evaluacion Academica</a>
        <a style=" margin-left: 15px ; width: 138px ; background-color: #B8D8F8; color: #000066; display: block; font-size: 11px; font-weight: bold; margin-bottom: 25px; margin-top: -20px ; padding: 6px 8px; text-decoration: none;" href="#">Fecha de Análisis</a>
        <a style=" margin-left: 15px ; width: 138px ; background-color: #B8D8F8; color: #000066; display: block; font-size: 11px; font-weight: bold; margin-bottom: 25px; margin-top: -20px ; padding: 6px 8px; text-decoration: none;" href="#">Form. Beca IDH</a>
        <a style=" margin-left: 15px ; width: 138px ; background-color: #B8D8F8; color: #000066; display: block; font-size: 11px; font-weight: bold; margin-bottom: 25px; margin-top: -20px ; padding: 6px 8px; text-decoration: none;" href="#">Control de Materias</a>
        <a style=" margin-left: 15px ; width: 138px ; background-color: #B8D8F8; color: #000066; display: block; font-size: 11px; font-weight: bold; margin-bottom: 25px; margin-top: -20px ; padding: 6px 8px; text-decoration: none;" href="#">Cambiar Contraseña</a>
        <a style=" margin-left: 15px ; width: 138px ; background-color: #B8D8F8; color: #000066; display: block; font-size: 11px; font-weight: bold; margin-bottom: 25px; margin-top: -20px ; padding: 6px 8px; text-decoration: none;" href="#">Solicitar Sevicio</a>
      ...
      <div style="margin-top: -5px ;width: 1350px">
        <section  class="py-4" style="align-items: center">
          @yield('content')
        </section>
       </div>
    </div>
